...
var offcanvas = document.getElementsByClassName('off-canvas-toggle')
for (var i = offcanvas.length - 1; i >= 0; i--) {
  var el = offcanvas[i]
  el.onclick = function(e) {
    e.preventDefault()
    document.querySelector('.off-canvas-container').classList.toggle('is-active')
  }
}
